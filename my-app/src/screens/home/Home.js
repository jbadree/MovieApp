...
//Newer version of material-ui use imageList instead of gridlist but alias has been used as gridlist was expected in evaluation
...
class Home extends Component {
    ...
    //To avoid deparcation warning UNSAFE_ keyword has been used as newer versions are moving away from componentwillmount
    ...
    //All the movie filters are accessible seperately
    ...
    // the render function puts it all together
    render() {
        ...
        return (
            <div>
                ...
                <div className="flex-container">
                    <div className="left">
                        <GridList rowHeight={350} cols={4} className={classes.gridListMain}>
